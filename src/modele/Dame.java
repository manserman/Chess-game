...
public class Dame extends Piece
{
	...
	public boolean moveIsPossible(Case c)
	{
		...
		// Deuxieme cas: la case n'est ni sur la meme ligne ni sur la meme colonne ni sur une des deux diagonales
		if(c.getLigne()							!= position.getLigne() 
		&& c.getColonne()						!= position.getColonne()
		&& c.getColonne()-position.getColonne() != c.getLigne()-position.getLigne()
